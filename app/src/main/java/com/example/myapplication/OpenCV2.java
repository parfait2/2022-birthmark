...
public class OpenCV2 extends Activity implements CvCameraViewListener2, OnTouchListener {
        ...
        public void onManagerConnected(int status) {
            switch (status) {
                case LoaderCallbackInterface.SUCCESS:
                {
                    ...
                    mOpenCvCameraView.setOnTouchListener(OpenCV2.this);
                } break;
                default:
                {
...
//                toastMesage = "Native Camera";
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        switch (OpenCV2.viewMode) {

            case OpenCV2.VIEW_MODE_A:
                homogeneousBlurTutorial();
                break;
            case OpenCV2.VIEW_MODE_B:
                gaussianBlurTutorial();
                break;
            case OpenCV2.VIEW_MODE_C:
                medianBlurTutorial();
                break;
            case OpenCV2.VIEW_MODE_D:
                bilateralFilterTutorial();
                break;
            case OpenCV2.VIEW_MODE_E:
                erosionTutorial(0);
                break;
            case OpenCV2.VIEW_MODE_F:
                dilationTutorial(0);
                break;
            case OpenCV2.VIEW_MODE_G:
                morphologyOperations(Imgproc.MORPH_GRADIENT, Imgproc.MORPH_RECT);
                break;
            case OpenCV2.VIEW_MODE_H:
                findContoursTutorial();
                break;
            case OpenCV2.VIEW_MODE_I:
                rotationTutorial();
                break;
            case OpenCV2.VIEW_MODE_J:
